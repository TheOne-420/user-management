...
function Navbar() {
  ...
  return (
    <nav className='sticky top-0 z-50 backdrop-blur-lg  flex flex-1 items-center justify-around bg-secondary text-primary p-4 shadow-md dark:bg-secondary-dark dark:text-accent-dark'>
